  ...
  return (
    <div className="max-w-2xl mx-auto">
        ...
        <div className="card space-y-3">
          ...
          {isInProgress && hasForm && (
            <Link href={`/jobs/${job._id}/form`} className="btn-secondary w-full flex items-center justify-center gap-2 py-3 text-lg">
              <Wrench className="w-5 h-5" /> Continue Form
            </Link>
          )}
      ...
      {showComplete && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
            <h3 className="text-lg font-semibold mb-4">Complete Work</h3>
            <p className="text-sm text-gray-500 mb-3">Add any notes about the maintenance work (optional).</p>
            <textarea
              className="input-field mb-4"
              rows={3}
